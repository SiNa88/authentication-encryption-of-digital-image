...
%http://www.mathworks.com/matlabcentral/fileexchange/25303-image-halftoning
%-by-jarvis-method/content/ImageHalftoningJarvis/jarvisHalftone.m
...
y= [T*ones(M,2) y T*ones(M,2) ; T*ones(2,N+4)];
z = y;
