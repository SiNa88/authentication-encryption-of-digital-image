function P_IP=InitialPermutation_DES(P_binry)
%   The order of 64-bit input changes according to below 
%   for Optimization & symmetry of the network
%   & doesn't help the strength of the algorithm!!!
P_IP=P_binry(1,[58,50,42,34,26,18,10,2,60,52,44,36,28,20,12,4,62,54,...
