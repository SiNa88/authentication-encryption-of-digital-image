function [Img_Encrypted_red Img_Encrypted_green Img_Encrypted_blue Img_Decrypted]=CTR(Im,key)
...
%         subplot(1,3,2), imshow(Img_Encrypted_red),title('Encrypted Image') ,...
%         subplot(1,3,3), imshow(uint8(Img_Decrypted)),title('DecryptedImage');
end
tEnd = toc(tStart);
